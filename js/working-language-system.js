...
function getUIText(key) {
  const uiTranslations = {
    'en': {
      ...
      'welcome': 'Welcome to Women World Beauty & Spa',
    ...
    'ar': {
      ...
      'addToCart': 'أضف للسلة',
      'welcome': 'مرحباً بكم في عالم المرأة للجمال والسبا',
    ...
    'de': {
      ...
      'welcome': 'Willkommen bei Women World Beauty & Spa',
    ...
    'fr': {
      ...
      'welcome': 'Bienvenue au Women World Beauty & Spa',
    ...
    'ru': {
      ...
      'addToCart': 'В корзину',
      'welcome': 'Добро пожаловать в Women World Beauty & Spa',
    ...
    'it': {
      ...
      'welcome': 'Benvenuti al Women World Beauty & Spa',
    ...
    'hu': {
      ...
      'welcome': 'Üdvözöljük a Women World Beauty & Spa-ban',
    ...
    'hr': {
      ...
      'welcome': 'Dobrodošli u Women World Beauty & Spa',
    ...
    'es': {
      ...
      'welcome': 'Bienvenido a Women World Beauty & Spa',
    ...
    'cs': {
      ...
      'welcome': 'Vítejte ve Women World Beauty & Spa',
    ...
    'lv': {
      ...
      'welcome': 'Laipni lūdzam Women World Beauty & Spa',
    ...
    'zh': {
      ...
      'viewDetails': '查看详情',
      'addToCart': '加入购物车',
      'welcome': '欢迎来到 Women World Beauty & Spa',
